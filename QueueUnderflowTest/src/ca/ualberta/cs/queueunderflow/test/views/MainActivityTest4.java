...
public class MainActivityTest4 extends ActivityInstrumentationTestCase2<MainActivity> {
	//Testing sort by LEAST RECENT QUESTIONS display
	Question question1;
	Question question2;
	Question question3;
	
	public MainActivityTest4() {
