...
public class MainActivityTest3 extends ActivityInstrumentationTestCase2<MainActivity> {
	//Testing Sort By Most Recent Questions Display
	Question question1;
	Question question2;
	Question question3;
	
	public MainActivityTest3() {
